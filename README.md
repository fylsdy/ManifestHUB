...
* API 调用方法: `https://api.manifesthub2.filegear-sg.me/manifest?apikey=<API密钥>&depotid=<depotid>&manifestid=<清单id>`
* API Call Method: `https://api.manifesthub2.filegear-sg.me/manifest?apikey=<API Key>&depotid=<depotid>&manifestid=<manifest id>`
* 获取API密钥/Get API Key: [https://manifesthub2.filegear-sg.me](https://manifesthub2.filegear-sg.me)
